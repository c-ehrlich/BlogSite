...
SECRET_KEY = "django-insecure-0qob(8v+)$7=sc@4=hit)ei*6i-bz#y8_vsb(^f0za4=&9xrn1"
...
# Custom user model
AUTH_USER_MODEL = "users.NewUser"  # TODO change this name, it's awful
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': SECRET_KEY,  # was settings.SECRET_KEY
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
    'JWK_URL': None,
